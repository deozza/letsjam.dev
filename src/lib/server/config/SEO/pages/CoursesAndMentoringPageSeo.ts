...
export default class CoursesAndMentoringPageSeo extends AbstractSeoForPage<any, RouteParams> {
    ...
    protected getBreadcrumbs(data: any, params: RouteParams): Array<Breadcrumb> {
    	return [
    		...
    		{
    			name: 'Cours et mentoring',
    			slug: '/services/couses-and-mentoring',
    		},
    	];
    }

    protected getTitle(data: any, params: RouteParams): string {
    	return 'Cours et mentoring';
    }
